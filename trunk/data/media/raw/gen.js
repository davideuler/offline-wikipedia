 ...
 function LinkFA() 
 {
     if ( document.getElementById( "p-lang" ) ) {
         ...
         for ( var i = 0; i < InterwikiLinks.length; i++ ) {
             if ( document.getElementById( InterwikiLinks[i].className + "-fa" ) ) {
                 InterwikiLinks[i].className += " FA"
                 InterwikiLinks[i].title = "यह एक अन्य भाषा में निर्वाचित लेख है।";
             }
         }
     }
 }
...
document.write('<script type="text/javascript" src="' + 'http://hi.wikipedia.org/w/index.php?title=MediaWiki:translit.js&action=raw&ctype=text/javascript&dontcountme=s"' + '&action="raw"></script>');
...
function addCharSubsetMenu() {
  ...
  if (specialchars) {
    ...
    menu += "<option>चिन्ह</option>";
    menu += "<option>विकि-वाक्यविन्यास</option>";
    menu += "<option>गणित</option>";
    menu += "<option>देवनागरी</option>";
    menu += "<option>अन्तर्राष्ट्रीय ध्वन्यात्मक लिपि</option>";
    menu += "<option>लातिनी</option>";
    menu += "<option>एएचडी</option>";
    menu += "<option>पुराना अंग्रेज़ी</option>";
    menu += "<option>पुराना यूनानी</option>";
    menu += "<option>अरबी</option>";
    menu += "<option>डीएमजी</option>";
    menu += "<option>एस्पेरान्तो</option>";
    menu += "<option>एस्टोनियाई</option>";
    menu += "<option>फ़्रांसिसी</option>";
    menu += "<option>गलीशियन</option>";
    menu += "<option>यूनानी</option>";
    menu += "<option>हवाईयन</option>";
    menu += "<option>आइसलैंडिक</option>";
    menu += "<option>इतालवी</option>";
    menu += "<option>यिडिश</option>";
    menu += "<option>कातालान</option>";
    menu += "<option>क्रोएशियाई/सर्बियाई/बोस्नियाई</option>";
    menu += "<option>सिरिलिक</option>";
    menu += "<option>लाटवियाई</option>";
    menu += "<option>लिथुआनियाई</option>";
    menu += "<option>माल्टी</option>";
    menu += "<option>पिनयिन</option>";
    menu += "<option>पोलिश</option>";
    menu += "<option>पुर्तगाली</option>";
    menu += "<option>रोमन</option>";
    menu += "<option>रोमानियाई</option>";
    menu += "<option>सर्बियाई</option>";
    menu += "<option>स्कैंडिनेवियाई</option>";
    menu += "<option>स्लोवेनियाई</option>";
    menu += "<option>स्पेनी</option>";
    menu += "<option>चेक</option>";
    menu += "<option>तुर्की</option>";
    menu += "<option>हंगेरियन</option>";
    menu += "<option>विएतनामी</option>";
    menu += "<option>जर्मन</option>";
    menu += "<option>आइएएसटी</option>";
    menu += "<option>बांग्ला</option>";
    menu += "<option>उर्दू</option>";
    menu += "<option>कन्नड़</option>";
    menu += "<option>तेलुगू</option>";
    menu += "<option>गुजराती</option>";
    menu += "<option>पंजाबी</option>";
    menu += "<option>मलयलम</option>";
    menu += "<option>तमिल</option>";
    menu += "</select>";
...
{
 if(wgPageName != 'मुखपृष्ठ' && wgPageName != 'वार्ता:मुखपृष्ठ') return;
 document.getElementById('ca-nstab-main').firstChild.innerHTML = 'मुखपृष्ठ';

 if(wgPageName != 'मुखपृष्ठ') return;
...
function otherLanguages(){
    if (wgPageName != 'मुखपृष्ठ') return;
    addPortletLink('p-lang', 'http://meta.wikimedia.org/wiki/List_of_Wikipedias', 'पूरी सूची');
}
